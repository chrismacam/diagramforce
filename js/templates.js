...
export const TEMPLATE_CATEGORIES = [
  ...
  // ── Industries ─────────────────────────────────────────────────────
  {
    ...
    templates: [
      ...
      node('Retail',               'retail_execution', { bg: '#9B59B6' }),
      ...
      node('Public Sector',        'solution',         { bg: '#1F618D' }),
  ...
  // ── Generic Architecture ───────────────────────────────────────────
  {
    ...
    templates: [
      ...
      node('API Gateway',           'payment_gateway',   { bg: '#2A9D8F' }),
      node('Data Lake',             'data_lake_objects',  { bg: '#1B4965' }),
      node('Data Warehouse',        'data_streams',      { bg: '#293241' }),
    ],
  },
  // ── External Systems ───────────────────────────────────────────────
  {
  ...
  // ── Integrations & APIs ────────────────────────────────────────────
  {
    ...
    templates: [
      node('REST API',            'connected_apps',           { bg: '#2A9D8F' }),
      node('SOAP API',            'connected_apps',           { bg: '#457B9D' }),
      node('GraphQL API',         'connected_apps',           { bg: '#E535AB' }),
      node('Bulk API',            'data_streams',             { bg: '#264653' }),
      node('Pub/Sub API',         'topic2',                   { bg: '#F4A261' }),
      node('Streaming API',       'live_chat',                { bg: '#E9C46A' }),
      node('Change Data Capture', 'record_update',            { bg: '#E76F51' }),
      node('Platform Events',     'event',                    { bg: '#9B7DD4' }),
      node('Event Relay',         'broadcast',                { bg: '#DA4E55' }),
      node('Private Connect',     'locker_service_api_viewer', { bg: '#555555' }),
      node('SFTP',                'upload',                   { bg: '#6D6875' }),
    ],
  },
  // ── Programmatic Languages ─────────────────────────────────────────
  {
    ...
    templates: [
      ...
      node('SQL',         'database',            { bg: '#3D5A80' }),
      node('SOQL',        'database',            { bg: '#1D73C9' }),
      node('SOSL',        'database',            { bg: '#457B9D' }),
  ...
  // ── MCE Journey Builder Activities ─────────────────────────────────
  {
    ...
    templates: [
      ...
      node('Path Optimizer',          'steps',     { bg: '#E97628' }),
  ...
  // ── MCE Automation Studio Activities ───────────────────────────────
  {
    ...
    collapsed: true,
    templates: [
      node('SQL Query',       'database',       { bg: '#3D5A80' }),
