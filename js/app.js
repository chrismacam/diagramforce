...
import * as theme       from './theme.js?v=1.8.0';
import * as icons       from './icons.js?v=1.8.0';
import { getAllStencilSvgs } from './templates.js?v=1.8.0';
import * as shapes      from './shapes.js?v=1.8.0';
import * as canvas      from './canvas.js?v=1.8.0';
import * as stencil     from './stencil.js?v=1.8.0';
import * as selection   from './selection.js?v=1.8.0';
import * as history     from './history.js?v=1.8.0';
import * as clipboard   from './clipboard.js?v=1.8.0';
import * as keyboard    from './keyboard.js?v=1.8.0';
import * as toolbar     from './toolbar.js?v=1.8.0';
import * as properties  from './properties.js?v=1.8.0';
