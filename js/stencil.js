...
import { TEMPLATE_CATEGORIES, BPMN_CATEGORIES, DATAMODEL_CATEGORIES, GANTT_CATEGORIES, ORG_CATEGORIES, SEQUENCE_CATEGORIES, createElementFromTemplate } from './templates.js?v=1.7.2';
import { getAllIcons, getCategories } from './icons.js?v=1.7.2';
import { updateSimpleNodeLayout, snapActivationToLifeline } from './canvas.js?v=1.7.2';
